...
return [
    false, // $matchHost
    [ // $staticRoutes
        '/cinema/list/genres' => [[['_route' => 'cinema_genres_list', '_controller' => 'App\\Controller\\MoviesController::index'], null, null, null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/api(?'
    ...
    [ // $dynamicRoutes
        ...
        281 => [
            [['_route' => 'movies', '_controller' => 'App\\Controller\\MoviesController::movies'], ['genreId'], null, null, false, false, null],
