...
class ApiPlatformConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
     ...
     */
    public function doctrine(array $value = []): \Symfony\Config\ApiPlatform\DoctrineConfig|static
    {
        if (!\is_array($value)) {
    ...
    */
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('doctrine', $value)) {
            $this->_usedProperties['doctrine'] = true;
            $this->doctrine = \is_array($value['doctrine']) ? new \Symfony\Config\ApiPlatform\DoctrineConfig($value['doctrine']) : $value['doctrine'];
