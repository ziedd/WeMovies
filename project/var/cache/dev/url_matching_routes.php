...
return [
    false, // $matchHost
    [ // $staticRoutes
        '/login' => [[['_route' => 'app_login_page', '_controller' => 'App\\Controller\\LoginPageController::index'], null, ['GET' => 0], null, false, false, null]],
        '/logout' => [[['_route' => 'app_logout_page', '_controller' => 'App\\Controller\\LogoutPageController::index'], null, ['GET' => 0], null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/api(?'
